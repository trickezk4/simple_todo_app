...
String getBackendUrl() {
  if (kIsWeb) {
    return 'http://localhost:8080'; //hoặc sử dụng địa chỉ IP LAN nếu cần
...
class TodoViews extends StatefulWidget {
  const TodoViews({super.key});

  @override
  State<TodoViews> createState() => _TodoViewState();
}

class _TodoViewState extends State<TodoViews> {
  ...
  // Thêm một todo mới sử dụng POST
  ...
  // Cập nhật trạng thái completed của todo sử dụng PUT
  ...
  void initState() {
    ...
    super.initState();
    _fetchTodos(); // Khi khởi tạo widget lần đầu thì lấy dánh sách todo
  }
